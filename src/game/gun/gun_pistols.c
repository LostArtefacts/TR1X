...
void Gun_Pistols_Undraw(LARA_GUN_TYPE weapon_type)
{
    ...
    g_Lara.head_x_rot = (g_Lara.right_arm.rot.x + g_Lara.left_arm.rot.x) / 4;
    g_Lara.head_y_rot = (g_Lara.right_arm.rot.y + g_Lara.left_arm.rot.y) / 4;
    g_Lara.torso_x_rot = (g_Lara.right_arm.rot.x + g_Lara.left_arm.rot.x) / 4;
    g_Lara.torso_y_rot = (g_Lara.right_arm.rot.y + g_Lara.left_arm.rot.y) / 4;
}
...
void Gun_Pistols_Control(LARA_GUN_TYPE weapon_type)
{
    ...
    if (g_Lara.left_arm.lock && !g_Lara.right_arm.lock) {
        ...
        g_Lara.torso_x_rot = g_Lara.right_arm.rot.x / 2;
        g_Lara.torso_y_rot = g_Lara.right_arm.rot.y / 2;
    } else if (g_Lara.left_arm.lock && g_Lara.right_arm.lock) {
        if (g_Camera.type != CAM_LOOK) {
            g_Lara.head_x_rot =
